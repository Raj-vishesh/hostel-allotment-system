      ...
      <div className="lg:w-1/2 relative min-h-[420px] lg:min-h-screen flex flex-col justify-between p-8 sm:p-14 text-white overflow-hidden bg-[#004d40]">
        ...
        <div className="relative z-10 flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-sm text-emerald-200 font-semibold m-0 tracking-wide">Hostel Allotment Portal</p>
          </div>
        </div>
        ...
        <div className="relative z-10 my-12 lg:my-0 max-w-xl">
          ...
          <p className="text-emerald-100/90 text-base sm:text-lg leading-relaxed">
            Register, explore residence halls across our 5 blocks (A to E), and rank your preferred rooms.
              ...
              <form onSubmit={handleSignIn} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-slate-50/50 text-slate-900 placeholder-slate-400 text-base focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#00695c] focus:border-transparent transition"
                  />
                </div>
                  ...
                  <>
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-slate-50/50 text-slate-900 text-base focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#00695c] focus:border-transparent transition"
                      >

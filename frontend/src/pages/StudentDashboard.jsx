          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs mb-8 print:hidden">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-6 border-t border-slate-100 text-slate-700">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/70">
                ...
                <p className="text-lg sm:text-xl font-black text-[#00695c] mt-1">{preferences.length} Selected</p>
              </div>
            </div>
          </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-3.5">
                      ...
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-300 bg-slate-50/50 text-slate-900 placeholder-slate-400 text-base focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#00695c] focus:border-transparent transition"
                        />
                      </div>
